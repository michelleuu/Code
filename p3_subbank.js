...
const P3_KEY = {
   1:3,  2:5,  3:2,  4:1,  5:4,  6:3,  7:4,  8:5,  9:4, 10:5, 11:1, 12:4,
  13:4, 14:4, 15:5, 16:3, 17:4, 18:3, 19:2, 20:1, 21:4, 22:4, 23:1, 24:1,
  25:5, 26:4, 27:4, 28:4, 29:4, 30:4, 31:2, 32:2, 33:4, 34:4, 35:3, 36:3,
  37:4, 38:3, 39:1, 40:4, 41:3, 42:1, 43:2, 44:4, 45:1, 46:3, 47:4, 48:5,
  49:4, 50:2, 51:3, 52:5, 53:4, 54:1, 55:4, 56:2, 57:5, 58:4, 59:1, 60:1,
  61:3, 62:5, 63:3, 64:2, 65:5, 66:1, 67:3, 68:3, 69:1, 70:4, 71:2, 72:5,
  73:3, 74:4, 75:1, 76:2, 77:1, 78:3, 79:3, 80:3, 81:1, 82:5, 83:4, 84:3,
  85:3, 86:1, 87:3, 88:2, 89:1, 90:4, 91:2, 92:5, 93:3, 94:2, 95:5, 96:2,
};
...
const item = (id) => ({
  id, file: `${STIM_DIR}/P3-${id}.png`, correctResp: P3_KEY[id],
});

// deterministic sequential cursor through the experimental pool
function cursor() { let i = 0; return (n) => EXPERIMENTAL.slice(i, (i += n)).map(item); }
...
function p3Framing(domain, tier) {
  ...
  const feedback = {
    easy: {
      pride: [
        { id: "pride_ind",  comparison: "individuating",    attribution: "ability_effort", severity: 1,
          requiresOutcome: "correct", pctRef: "self_score", referent: ref, pct: [85, 98],
      ...
      relief: [
        { id: "relief_norm", comparison: "normative_shared", attribution: "task_difficulty", severity: 0,
          requiresOutcome: "correct", requiresExpectancy: "low", pctRef: "self_score", referent: ref,
          pct: [62, 82],
      ...
      shame: [
        { id: "shame_mild", comparison: "individuating", attribution: "ability", severity: 2,
          requiresOutcome: "incorrect", pctRef: "peer_success", referent: ref, pct: [82, 92],
          template: `\${pct}% of ${ref} matched more than you — quick visual matching may not be your strength.` },
      ],
      guilt: [
        { id: "guilt_norm", comparison: "individuating", attribution: "effort", severity: 1,
          requiresOutcome: "incorrect", pctRef: "peer_success", referent: ref, pct: [82, 92],
    ...
    mid: {
      pride: [
        { id: "pride_ind",  comparison: "individuating", attribution: "ability_effort", severity: 1,
          requiresOutcome: "correct", pctRef: "self_score", referent: ref, pct: [68, 82],
      ...
      guilt: [
        { id: "guilt_effort", comparison: "individuating", attribution: "effort", severity: 1,
          requiresOutcome: "incorrect", pctRef: "self_score", referent: ref, pct: [25, 45],
      ...
      disappointment: [
        { id: "disap_ind", comparison: "individuating", attribution: "none", severity: 1,
          ...
          pctRef: "self_score", referent: ref, pct: [25, 46],
      ...
      relief: [
        { id: "relief_self", comparison: "normative_shared", attribution: "task_difficulty", severity: 0,
          requiresOutcome: "correct", requiresExpectancy: "low",
          pctRef: "self_score", referent: ref, pct: [55, 78],
          template: `\${pct}th percentile — faster than most ${ref} at this pace.` },
      ],
      shame: [
        { id: "shame_mild", comparison: "individuating", attribution: "ability", severity: 2,
          requiresOutcome: "incorrect", pctRef: "peer_success", referent: ref, pct: [62, 78],
    ...
    hard: {
      shame: [
        { id: "shame_mild", comparison: "individuating", attribution: "ability", severity: 2,
          requiresOutcome: "incorrect", pctRef: "self_score", referent: ref, pct: [3, 18],
...
const TIERS = {
  easy: { count: 5, n: 4,
    calibration: { realPSuccess: 0.90, limitMs: 7000, blockRtMs: 7000,
                   plausiblePct: [65, 99], plausiblePctSpeed: [65, 99], passMark: 3 } },
  mid:  { count: 4, n: 6,
    calibration: { realPSuccess: 0.70, limitMs: 7000, blockRtMs: 7000,
                   plausiblePct: [25, 80], plausiblePctSpeed: [25, 78], passMark: 3 } },
  hard: { count: 6, n: 8,
    calibration: { realPSuccess: 0.55, limitMs: 7000, blockRtMs: 7000,
                   plausiblePct: [2, 45],  plausiblePctSpeed: [2, 42],  passMark: 2 } },
};

const P3_DOMAINS      = ["media", "design"];
const P3_INSTRUCTIONS = "Find the matching image in each row — work fast, accuracy counts.";
  ...
  for (const tier of ["easy", "mid", "hard"]) {
    ...
    for (let i = 1; i <= count; i++) {
      ...
      out.push(buildMediaTask({
        id, name: `Identical Pictures (P-3) — ${tier} block ${i} (ETS)`,
        domains: P3_DOMAINS, modality: "perceptual", languageLoad: "low",
        difficultyTier: tier, unit: "block",
        instructions: P3_INSTRUCTIONS, instructionsOnPrime: true,
        // custom speed-appropriate framing; bypasses buildMediaFraming
        framingOverride: Object.fromEntries(P3_DOMAINS.map(d => [d, p3Framing(d, tier)])),
